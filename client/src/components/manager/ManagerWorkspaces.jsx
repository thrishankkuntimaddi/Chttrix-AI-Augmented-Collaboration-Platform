// client/src/components/manager/ManagerWorkspaces.jsx
// Shows workspaces managed by the current manager

import React, { useState, useEffect } from 'react';
import { Globe, Users, MessageSquare, CheckCircle, Clock, Search } from 'lucide-react';
    ...
    const fetchWorkspaces = async () => {
        try {
            ...
            const response = await axios.get(
                `${process.env.REACT_APP_BACKEND_URL}/api/manager-dashboard/my-workspaces`,
        ...
        <div className="h-full bg-gray-50 dark:bg-gray-900">
            ...
            <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 px-8 py-6 mb-8">
                <div className="flex items-center justify-between">
                    <div>
                        <h1 className="text-2xl font-bold text-gray-900 dark:text-white">My Workspaces</h1>
                    ...
                    <div className="relative w-96">
                        ...
                        <input
                            ...
                            className="w-full pl-10 pr-4 py-2 border border-gray-200 dark:border-gray-700 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
                        />
                    </div>
                </div>
            </div>
                    ...
                    <div className="text-center py-16">
                        ...
                        <p className="text-gray-500 dark:text-gray-400">
                            {searchTerm
                                ...
                                : 'You are not managing any workspaces yet'}
                        </p>
                    </div>
                ) : (
                            ...
                            >
                                ...
                                <div className="flex items-center justify-between pt-4 border-t border-gray-100 dark:border-gray-700">
                                    <div className="flex items-center gap-2 text-xs text-gray-500 dark:text-gray-400">
                                        ...
                                        <span>{workspace.activity?.tasksCompleted || 0} tasks done</span>
                                    </div>
                                    <div className="flex items-center gap-2 text-xs text-gray-500 dark:text-gray-400">
                                        <Clock size={14} className="text-yellow-500" />
                                        <span>{workspace.activity?.tasksActive || 0} active</span>
                                    </div>
                                </div>
                            </div>
                        ))}
