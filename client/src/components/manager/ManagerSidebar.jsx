...
const ManagerSidebar = ({ activeTab, setActiveTab }) => {
    ...
    const menuItems = [
        ...
        { id: 'allocation', label: 'Team Allocation', icon: Users },
        { id: 'tasks', label: 'Task Master', icon: CheckSquare },
            ...
            <div className="p-4 border-t border-slate-100">
                <div className="flex items-center gap-3 px-4 py-2">
                    ...
                    <div className="flex-1 overflow-hidden">
                        <p className="text-sm font-bold truncate text-slate-800">{user?.username || 'Manager'}</p>
                        <p className="text-xs text-slate-400 truncate">Manager Console</p>
                    </div>
