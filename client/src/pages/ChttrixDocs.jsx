...
const ChttrixDocs = () => {
  ...
  const [billingType, setBillingType] = useState("personal"); // personal | company
        ...
        <div className="max-w-4xl mx-auto px-8 py-20 pb-20 text-slate-600 dark:text-slate-400">
          ...
          <div className="prose-slate dark:prose-invert">
            ...
            <section id="plans" className="scroll-mt-20 mb-20">
              <h2 className="text-slate-900 dark:text-white text-center mb-4">Plans & Billing</h2>
              <p className="text-center text-slate-500 mb-10 max-w-lg mx-auto">
                Flexible pricing options for individuals and organizations of all sizes.
              </p>

              {/* Toggle Switch */}
              <div className="flex justify-center mb-12">
                <div className="bg-slate-100 dark:bg-white/5 p-1 rounded-xl inline-flex items-center">
                  <button
                    onClick={() => setBillingType("personal")}
                    className={`px-6 py-2.5 rounded-lg text-sm font-bold transition-all duration-300 ${billingType === "personal"
                  ...
                  <button
                    ...
                    className={`px-6 py-2.5 rounded-lg text-sm font-bold transition-all duration-300 ${billingType === "company"
                      ? "bg-white dark:bg-indigo-600 text-slate-900 dark:text-white shadow-sm"
                      : "text-slate-500 hover:text-slate-900 dark:hover:text-white"
                      }`}
                  >
              ...
              {/* Personal Section */}
              <div className={`transition-all duration-500 ${billingType === "personal" ? "block opacity-100 translate-y-0" : "hidden opacity-0 translate-y-4"}`}>
                <div className="grid md:grid-cols-2 gap-8 max-w-3xl mx-auto not-prose">
                  {/* Personal: Free */}
                  <div className="flex flex-col p-8 rounded-3xl border border-slate-200 dark:border-white/5 bg-white dark:bg-[#0F1623] hover:border-indigo-200 dark:hover:border-indigo-500/30 transition-all duration-300 hover:shadow-2xl hover:shadow-indigo-500/10 group">
                    <div className="mb-6">
                      <h3 className="mt-0 text-2xl font-bold text-slate-900 dark:text-white group-hover:text-indigo-600 dark:group-hover:text-indigo-400 transition-colors">Free</h3>
                      <p className="text-sm text-slate-500 mt-2">Perfect for side projects & learning.</p>
                    </div>
                    <div className="text-4xl font-black text-slate-900 dark:text-white mb-8 tracking-tight">$0<span className="text-sm font-medium text-slate-500 ml-1">/mo</span></div>

                    <div className="space-y-4 mb-8 flex-1">
                      <div className="flex items-center gap-3 text-sm text-slate-600 dark:text-slate-300">
                        <div className="p-1 rounded-full bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-400"><Check size={12} /></div>
                    ...
                    <button className="w-full py-3.5 rounded-xl border border-slate-200 dark:border-white/10 font-bold hover:bg-slate-50 dark:hover:bg-white/5 text-slate-900 dark:text-white transition-colors text-sm">
                      Get Started
                    </button>
                  </div>

                  {/* Personal: Pro (Limited) */}
                  <div className="flex flex-col p-8 rounded-3xl border-2 border-indigo-500 bg-white dark:bg-[#0F1623] relative shadow-2xl shadow-indigo-500/10 scale-105 z-10">
                    <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 px-4 py-1 bg-gradient-to-r from-indigo-600 to-purple-600 text-white text-xs font-bold uppercase tracking-wider rounded-full shadow-lg">Most Popular</div>
                    <div className="mb-6">
                      <div className="flex items-center gap-2">
                        <h3 className="mt-0 text-2xl font-bold text-slate-900 dark:text-white">Pro</h3>
                        <span className="px-2 py-0.5 rounded text-[10px] font-bold uppercase bg-amber-100 text-amber-700 dark:bg-amber-900/30 dark:text-amber-400 border border-amber-200 dark:border-amber-500/20">Limited</span>
                      </div>
                      <p className="text-sm text-slate-500 mt-2">For power users who need more.</p>
                    </div>
                    <div className="text-4xl font-black text-slate-900 dark:text-white mb-8 tracking-tight">$8<span className="text-sm font-medium text-slate-500 ml-1">/mo</span></div>

                    <div className="space-y-4 mb-8 flex-1">
                      <div className="flex items-center gap-3 text-sm text-slate-900 dark:text-white font-medium">
                        <div className="p-1 rounded-full bg-indigo-100 dark:bg-indigo-500/30 text-indigo-600 dark:text-indigo-300"><Check size={12} /></div>
                    ...
                    <button className="w-full py-3.5 rounded-xl bg-gradient-to-r from-indigo-600 to-purple-600 text-white font-bold hover:opacity-90 transition-opacity shadow-lg shadow-indigo-500/25 text-sm">
                      Upgrade to Pro
                    </button>
                  </div>
                </div>
              ...
              {/* Company Section */}
              <div className={`transition-all duration-500 ${billingType === "company" ? "block opacity-100 translate-y-0" : "hidden opacity-0 translate-y-4"}`}>
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4 not-prose">

                  {/* Company: Free */}
                  <div className="flex flex-col p-6 rounded-2xl border border-slate-200 dark:border-white/5 bg-white dark:bg-[#0F1623] hover:border-slate-300 dark:hover:border-white/10 transition-all">
                    <h3 className="mt-0 text-lg font-bold text-slate-900 dark:text-white">Free</h3>
                    <p className="text-xs text-slate-500 mb-4 h-8">Small teams trying it out</p>
                    <div className="text-3xl font-black text-slate-900 dark:text-white mb-6">$0<span className="text-xs font-medium text-slate-500 ml-1">/mo</span></div>

                    <div className="space-y-3 mb-6 flex-1">
                      <li className="flex items-start gap-2 text-xs text-slate-600 dark:text-slate-300">
                        <Check size={14} className="text-slate-400 shrink-0 mt-0.5" /> <span>1 Company Workspace</span>
                      </li>
                      <li className="flex items-start gap-2 text-xs text-slate-600 dark:text-slate-300">
                        <Check size={14} className="text-slate-400 shrink-0 mt-0.5" /> <span>5 Members Max</span>
                      </li>
                    </div>
                    <button className="w-full py-2.5 rounded-lg border border-slate-200 dark:border-white/10 font-bold hover:bg-slate-50 dark:hover:bg-white/5 transition-colors text-xs text-slate-900 dark:text-white">
                      Try Free
                    </button>
                  </div>
                  ...
                  {/* Company: Team */}
                  <div className="flex flex-col p-6 rounded-2xl border border-slate-200 dark:border-white/5 bg-white dark:bg-[#0F1623] hover:border-slate-300 dark:hover:border-white/10 transition-all">
                    <h3 className="mt-0 text-lg font-bold text-slate-900 dark:text-white">Team</h3>
                    <p className="text-xs text-slate-500 mb-4 h-8">For growing startups</p>
                    <div className="text-3xl font-black text-slate-900 dark:text-white mb-6">$10<span className="text-xs font-medium text-slate-500 ml-1">/user/mo</span></div>

                    <div className="space-y-3 mb-6 flex-1">
                      <li className="flex items-start gap-2 text-xs text-slate-600 dark:text-slate-300">
                        <Check size={14} className="text-green-500 shrink-0 mt-0.5" /> <span>Unlimited Workspaces</span>
                      </li>
                      <li className="flex items-start gap-2 text-xs text-slate-600 dark:text-slate-300">
                        <Check size={14} className="text-green-500 shrink-0 mt-0.5" /> <span>Guest Access</span>
                      </li>
                    </div>
                    <button className="w-full py-2.5 rounded-lg border border-slate-200 dark:border-white/10 font-bold hover:bg-slate-50 dark:hover:bg-white/5 transition-colors text-xs text-slate-900 dark:text-white">
                      Get Team
                  ...
                  {/* Company: Business */}
                  <div className="flex flex-col p-6 rounded-2xl border-2 border-indigo-500 bg-white dark:bg-[#0F1623] relative shadow-xl shadow-indigo-500/10 scale-105 z-10">
                    <div className="absolute -top-3 left-1/2 -translate-x-1/2 px-3 py-0.5 bg-indigo-600 text-white text-[10px] font-bold uppercase tracking-wider rounded-full shadow-md whitespace-nowrap">Best Value</div>
                    <h3 className="mt-0 text-lg font-bold text-indigo-600 dark:text-indigo-400">Business</h3>
                    <p className="text-xs text-slate-500 mb-4 h-8">Scale & security</p>
                    <div className="text-3xl font-black text-slate-900 dark:text-white mb-6">$20<span className="text-xs font-medium text-slate-500 ml-1">/user/mo</span></div>

                    <div className="space-y-3 mb-6 flex-1">
                      <li className="flex items-start gap-2 text-xs text-slate-900 dark:text-white font-medium">
                        <Check size={14} className="text-indigo-600 shrink-0 mt-0.5" /> <span>SSO / SAML</span>
                      </li>
                      <li className="flex items-start gap-2 text-xs text-slate-900 dark:text-white font-medium">
                        <Check size={14} className="text-indigo-600 shrink-0 mt-0.5" /> <span>99.9% SVC Uptime</span>
                      </li>
                      <li className="flex items-start gap-2 text-xs text-slate-900 dark:text-white font-medium">
                        <Check size={14} className="text-indigo-600 shrink-0 mt-0.5" /> <span>Admin Insights</span>
                      </li>
                    </div>
                    <button className="w-full py-2.5 rounded-lg bg-indigo-600 text-white font-bold hover:bg-indigo-700 transition-colors shadow-lg shadow-indigo-500/25 text-xs">
                      Get Business
                    </button>
                  </div>
                  ...
                  {/* Company: Enterprise */}
                  <div className="flex flex-col p-6 rounded-2xl border border-slate-200 dark:border-white/5 bg-white dark:bg-[#0F1623] hover:border-slate-300 dark:hover:border-white/10 transition-all">
                    <h3 className="mt-0 text-lg font-bold text-slate-900 dark:text-white">Enterprise</h3>
                    <p className="text-xs text-slate-500 mb-4 h-8">Regulation & compliance</p>
                    <div className="text-3xl font-black text-slate-900 dark:text-white mb-6">Custom</div>

                    <div className="space-y-3 mb-6 flex-1">
                      <li className="flex items-start gap-2 text-xs text-slate-600 dark:text-slate-300">
                        <Check size={14} className="text-slate-400 shrink-0 mt-0.5" /> <span>Dedicated Instance</span>
                      </li>
                      <li className="flex items-start gap-2 text-xs text-slate-600 dark:text-slate-300">
                        <Check size={14} className="text-slate-400 shrink-0 mt-0.5" /> <span>Audit Logs & DLP</span>
                      </li>
                    </div>
                    <button className="w-full py-2.5 rounded-lg border border-slate-200 dark:border-white/10 font-bold hover:bg-slate-50 dark:hover:bg-white/5 transition-colors text-xs text-slate-900 dark:text-white">
                      Contact Sales
            ...
            <footer className="mt-16 pt-12 border-t border-slate-200 dark:border-white/5 text-center text-slate-500 dark:text-slate-600 text-sm">
              <p>© 2026 Chttrix Inc. Documentation</p>
            </footer>
          </div>
        </div>
      </main>
