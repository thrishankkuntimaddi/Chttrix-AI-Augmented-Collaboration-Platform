      ...
      <div className="max-w-md w-full bg-white p-6 rounded shadow">
        ...
        {status === 'success' && (
          <div>
            ...
            <p className="text-sm text-gray-600">You will be redirected to login shortly. Or click below to go now.</p>
            <div className="mt-4">
        ...
        {status === 'error' && (
          <div>
            ...
            <div className="flex gap-2">
              <button onClick={() => navigate('/login')} className="px-4 py-2 bg-gray-200 rounded">Go to Login</button>
