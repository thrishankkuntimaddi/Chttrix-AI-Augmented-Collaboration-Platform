    ...
    <div style={{ maxWidth: '560px', margin: '0 auto' }}>
        ...
        <label style={{ display: 'block', cursor: 'pointer' }}>
            ...
            <div style={{
                ...
                {formData.documents ? (
                    <>
                        <p style={{ fontSize: '14px', fontWeight: 700, color: 'var(--text-primary)' }}>{formData.documents.name}</p>
                    ...
                    <>
                        <p style={{ fontSize: '14px', fontWeight: 700, color: 'var(--text-primary)' }}>Drag & Drop or click to upload</p>
