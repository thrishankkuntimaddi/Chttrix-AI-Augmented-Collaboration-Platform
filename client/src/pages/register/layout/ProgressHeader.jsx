...
const ProgressHeader = ({ currentStep, theme }) => (
    <div style={{ padding: '24px 32px', borderBottom: '1px solid rgba(255,255,255,0.06)', flexShrink: 0, background: 'rgba(0,0,0,0.15)' }}>
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '16px' }}>
            <div>
                ...
                <h1 style={{ fontSize: '20px', fontWeight: 700, color: '#e4e4e4', letterSpacing: '-0.02em' }}>
