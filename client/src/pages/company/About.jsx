        ...
        <PublicPageShell title="About">
            ...
            <div style={{ borderBottom: '1px solid var(--border-subtle)', padding: '80px 0 64px' }}>
                <div style={{ maxWidth: '1160px', margin: '0 auto', padding: '0 24px' }}>
                    ...
                    <h1 style={{ fontSize: 'clamp(32px,5vw,56px)', fontWeight: 700, color: 'var(--text-primary)', letterSpacing: '-0.03em', lineHeight: 1.1, marginBottom: '20px', maxWidth: '700px' }}>
                        We're building the workspace<br />teams actually want to use.
                    </h1>
                    <p style={{ fontSize: '16px', color: 'var(--text-muted)', lineHeight: '1.8', maxWidth: '560px' }}>
            ...
            <div style={{ padding: '72px 0', borderBottom: '1px solid var(--border-subtle)' }}>
                <div style={{ maxWidth: '1160px', margin: '0 auto', padding: '0 24px', display: 'flex', gap: '80px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
                    <div style={{ flex: '1 1 300px' }}>
                        ...
                        <h2 style={{ fontSize: '28px', fontWeight: 700, color: 'var(--text-primary)', letterSpacing: '-0.025em', lineHeight: 1.2, marginBottom: '16px' }}>
                            Make every team feel like<br />a world-class team.
                        </h2>
                    </div>
                    <div style={{ flex: '2 1 400px' }}>
                        <p style={{ fontSize: '15px', color: 'var(--text-muted)', lineHeight: '1.85', marginBottom: '18px' }}>
                        ...
                        {VALUES.map(v => {
                            ...
                            return (
                                <div key={v.title} style={{ background: '#111', padding: '28px 24px' }}>
                                    ...
                                    <h3 style={{ fontSize: '15px', fontWeight: 700, color: 'var(--text-primary)', marginBottom: '8px' }}>{v.title}</h3>
                                    <p style={{ fontSize: '13px', color: 'var(--text-muted)', lineHeight: '1.75' }}>{v.desc}</p>
                                </div>
                            );
                        })}
                    </div>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(200px, 1fr))', gap: '1px', background: 'var(--bg-hover)' }}>
                        {TEAM.map(t => (
                            <div key={t.name} style={{ background: '#111', padding: '28px 24px', display: 'flex', flexDirection: 'column', alignItems: 'flex-start' }}>
                                ...
                                <h3 style={{ fontSize: '14px', fontWeight: 700, color: 'var(--text-primary)', marginBottom: '4px' }}>{t.name}</h3>
            ...
            <div style={{ padding: '72px 0', textAlign: 'center' }}>
                <div style={{ maxWidth: '480px', margin: '0 auto', padding: '0 24px' }}>
                    ...
                    <p style={{ fontSize: '14px', color: 'var(--text-muted)', marginBottom: '28px', lineHeight: '1.7' }}>We're a small team building something big. If that sounds exciting, see open roles.</p>
