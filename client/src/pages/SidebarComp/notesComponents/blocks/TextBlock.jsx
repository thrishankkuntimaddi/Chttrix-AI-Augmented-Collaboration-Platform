...
const TextBlock = ({ block, onBlockChange, onRemoveBlock, onSlashCommand, onAddBlockAfter, registerRef }) => {
    ...
    return (
        <div className="group relative mb-1">
            {/* Format Toolbar */}
            {showToolbar && (
                <div className="flex items-center gap-0.5 mb-2 px-2 py-1.5 bg-white dark:bg-gray-800 border border-gray-200/80 dark:border-gray-700/80 rounded-xl shadow-lg shadow-gray-200/60 dark:shadow-gray-950/60 w-fit backdrop-blur-sm">
