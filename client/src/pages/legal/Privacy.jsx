...
import {
    ...
    Fingerprint, FileText, Globe,
    ChevronRight, CheckCircle, Menu, X, ArrowLeft,
    UserCheck, Server, AlertCircle, Mail, Shuffle
} from 'lucide-react';
    ...
    <div className="space-y-10 animate-fade-in">
        ...
        <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="bg-indigo-600 text-white p-8 rounded-3xl shadow-xl flex flex-col justify-between">
                ...
                <a href="mailto:privacy@chttrix.com" className="bg-white text-indigo-700 px-6 py-3 rounded-xl font-bold text-center hover:bg-indigo-50 transition-colors">
                    privacy@chttrix.com
                </a>
            </div>
        </div>
