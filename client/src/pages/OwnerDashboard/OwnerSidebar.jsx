    ...
    const navGroups = [
        {
            ...
            items: [
                ...
                { path: '/owner/dashboard/activity', label: 'Activity Health', icon: Activity },
                { path: '/owner/dashboard/billing', label: 'Billing & Plan', icon: CreditCard },
                { path: '/owner/dashboard/security', label: 'Security & Risk', icon: Shield },
            ]
        },
        {
            group: 'ORGANIZATION',
